...
class PolicyLossConfig(BaseConfig):
    ...
    top_entropy_loss: float = 1.0
    log_external_prob: bool = True
    clip_lower: float = 0.8
    clip_upper: float = 1.2
    sequential_loss: bool = False
    loss_remove_token_mean: bool = False
    loss_remove_clip: bool = False
    our_solution: bool = False
    external_prob_shaping: str = None
    kl_coef_loss: str = None
    algo_type: str = None
